...
var VAddressList = /** @class */ (function (_super) {
    ...
    function VAddressList() {
        ...
        _this.onContactRender = function (userShippingContact) {
            var contact = userShippingContact.contact;
            var _a = _this.controller, onContactEdit = _a.onContactEdit, onContactSelected = _a.onContactSelected;
            var right = React.createElement("div", { className: "p-2 cursor-pointer text-info", onClick: function () { return onContactEdit(userShippingContact); } },
        ...
        _this.page = function () {
            var _a = _this.controller, onContactEdit = _a.onContactEdit, userShippingContacts = _a.userShippingContacts;
            ...
            return React.createElement(Page, { footer: footer, header: "\u7BA1\u7406\u5730\u5740" },
                React.createElement(List, { items: userShippingContacts, item: { render: _this.onContactRender }, none: "\u4F60\u8FD8\u6CA1\u6709\u8BBE\u7F6E\u6536\u8D27\u5730\u5740\uFF0C\u8BF7\u6DFB\u52A0\u65B0\u5730\u5740" }));
        };
        return _this;
    }
