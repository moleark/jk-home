...
var CTuidMain = /** @class */ (function (_super) {
    ...
    CTuidMain.prototype.cUsqFrom = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.entity.cUsqFrom()];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cUsq = _a.sent();
                        return [4 /*yield*/, cUsq.cTuidEditFromName(this.entity.name)];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cUsq = _a.sent();
                        return [4 /*yield*/, cUsq.cTuidInfoFromName(this.entity.name)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cUsq = _a.sent();
                        return [4 /*yield*/, cUsq.cTuidSelectFromName(this.entity.name)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/];
                    case 7:
                        cTuidInfo = new CTuidInfo(this.cUsq, this.entity, this.ui, this.res);
