...
var VProduct = /** @class */ (function (_super) {
    ...
    function VProduct() {
        ...
        _this.onQuantityChanged = function (context, value, prev) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, pack, retail, currency, cApp, cCart;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cCart = cApp.cCart;
                        return [4 /*yield*/, cCart.cart.AddToCart(this.product.id, pack, value, retail, currency)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        _this.arrTemplet = function (item) {
            ...
            var pack = item.pack;
            var retail = pack.retail, vipPrice = pack.vipPrice, inventoryAllocation = pack.inventoryAllocation, futureDeliveryTimeDescription = pack.futureDeliveryTimeDescription;
        ...
        _this.page = observer(function () {
            var _a = _this.controller, product = _a.product, cApp = _a.cApp;
            ...
            return React.createElement(Page, { header: header, right: cartLabel },
                React.createElement("div", { className: "px-2 py-2 bg-white" }, tv(_this.product.id, productRow)),
